...
Route::POST('/bangun-ruang/edit/{id}', [BangunRuangController::class, 'update'])->name('update');

Route::delete('/bangun-ruang/delete/{id}', [BangunRuangController::class, 'destroy'])->name('destroy');
